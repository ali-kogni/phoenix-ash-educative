defmodule AshPhoenixAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AshPhoenixAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AshPhoenixAppWeb.Gettext, "errors", msg, opts)
    end
  end
